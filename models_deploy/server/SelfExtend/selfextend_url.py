...
window_size = int(params["selfextend_window_size"])
group_size = int(params["selfextend_group_size"])
...
if 'Mistral' in model_path:
        ...
        model = AutoModelForCausalLM.from_pretrained(model_path, config=config, device_map="auto", torch_dtype=torch_dtype, attn_implementation="flash_attention_2")
else:
    model = AutoModelForCausalLM.from_pretrained(model_path, device_map="auto", torch_dtype=torch_dtype, attn_implementation="flash_attention_2")
