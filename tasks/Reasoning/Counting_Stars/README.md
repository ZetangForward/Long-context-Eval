...
```python
lte.run --model_path "meta-llama/Llama-3.1-8B-Instruct" --eval --benchmark_configs ./tasks/Reasoning/Counting_Stars/Counting_Stars.yaml --device 2,5,6,7 --save_tag "tag"
```
