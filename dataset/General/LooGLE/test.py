    ...
    for file in files:
        if file.endswith('.yaml'):
            ...
            with open(file_path, 'r', encoding='utf-8') as f:
                ...
                if "accuracy" in content["metric"]:
                    content["metric"]={content["metric"]["accuracy"]["evaluation"]["type"]:None}
                print(content["metric"])
                with open(file_path+'1', 'w', encoding='utf-8') as f:
                    yaml.dump(content, f)
